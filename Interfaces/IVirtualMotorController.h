...
public:
    ...
    virtual void setPosition(WbDeviceTag tag, double position) = 0;
    ...
    virtual void setAcceleration(WbDeviceTag tag, double acceleration) = 0;
    ...
    virtual void setVelocity(WbDeviceTag tag, double velocity) = 0;
